...
public class GetHTTPExpressionTest {
    ...
    public void getTest() {
        ...
        assertEquals("ดูดวงชะตารายวัน ประจำวันจันทร์ที่ 25 มีนาคม 2562 ดูดวงรายวัน ผู้ที่เกิดวันเสาร์ วันนี้เกิดอกสั่นขวัญแขวน หรือตื่นเต้นจนหลายด้านที่ควรต้องได้หลุดมือไป อาจเหนื่อยใจอยู่บ้างเรื่องญาติและบริวารลูกหลาน เงินทองก็ยังคงผ่านมือหลายจำนวน ในเชิงของความรักไม่วายสงสารต่อกันจนจับใจจัง", session.parse(MessageObject.build("เสาร์")));
        assertEquals("เกิดวันอะไร", session.parse(MessageObject.build("ดวง")));
        assertEquals("ดูดวงชะตารายวัน ประจำวันจันทร์ที่ 25 มีนาคม 2562 ดูดวงรายวัน ผู้ที่เกิดวันศุกร์ วันนี้ยังคงต้องจำใจค้นหาความจริงใจจากใครต่อใคร หรือเรื่องวุ่นวายที่เรามิได้ก่อแต่มันสุมอกใจเรามี เงินทองลาภผลจำนวนฝอยได้แต่ก้อนโตต้องรออีกระยะ ความรักก็แสนจะแบบบางต้องระวังให้มากไว้บ้าง", session.parse(MessageObject.build("ศุกร์")));
