...
public class GetHTTPExpressionTest {
    ...
    public void getTest() {
        ...
        assertEquals("ดูดวงชะตารายวัน ประจำวันอาทิตย์ที่ 10 มีนาคม 2562 ดูดวงรายวัน ผู้ที่เกิดวันเสาร์ วันนี้ปัญหาโลกแตก ที่ยากจะแยกก่อนหลังขาวดำยังคงพาให้คิดหนัก เงินทอง ไหลไม่ลื่นดั่งเดิม เริ่มต้นเรื่องใดต้องมีเพศตรงข้ามคนต่างวัยหนุนจึงลุล่วงลงเอยได้ เรื่องของความรักก็กำลังคิดมากต่อกันทั้งเขาเรา", session.parse(MessageObject.build("เสาร์")));
        assertEquals("เกิดวันอะไร", session.parse(MessageObject.build("ดวง")));
        assertEquals("ดูดวงชะตารายวัน ประจำวันอาทิตย์ที่ 10 มีนาคม 2562 ดูดวงรายวัน ผู้ที่เกิดวันศุกร์ วันนี้ยังไม่วายต้องคิดเล็กคำนึงน้อย หรือพลอยเดือดร้อนกับใครต่อใครไปด้วย ทั้งที่นอนหลับไม่รู้นอนคู้ไม่เห็น สุขภาพกายช่วงนี้ก็ต้องระวัง หยูกยาใกล้ตัวไว้เป็นดี ความรักก็กำลังล้นปรี่ทั้งคนเก่าเจ้าใหม่", session.parse(MessageObject.build("ศุกร์")));
