...
public class GetHTTPExpressionTest {
    ...
    public void getTest() {
        ...
        assertEquals("ดูดวงชะตารายวัน ประจำวันเสาร์ที่ 23 มีนาคม 2562 ดูดวงรายวัน ผู้ที่เกิดวันเสาร์ วันนี้ทุกอย่างยังคงจำใจจับต้นชนปลาย หรืออาจช้ำใจตนเรื่องของคนรอบข้างไม่จริงจังด้วยนั่น ลาภผลเงินทองรับเข้าแบ่งปันมาแต่มันก็อยู่ด้วยไม่นานนัก สุขภาพท้องไส้ต้องระวังมั่ง ความรักยังเหมือนเดิมทุกราย", session.parse(MessageObject.build("เสาร์")));
        assertEquals("เกิดวันอะไร", session.parse(MessageObject.build("ดวง")));
        assertEquals("ดูดวงชะตารายวัน ประจำวันเสาร์ที่ 23 มีนาคม 2562 ดูดวงรายวัน ผู้ที่เกิดวันศุกร์ วันนี้ปัญหาที่ยังคงคาใจมีหลายประการ เงินทองก็ยังคงผ่านมือหลายจำนวน การต่อรองแต่ละอย่างมันกำลังเข้าทางใครอื่น เดินทางไกลไปไหนไกลเรือนจึงสดชื่นด้วยดี ช่วงนี้ความรักค่อยโปร่งใสได้บ้างนี่นา.", session.parse(MessageObject.build("ศุกร์")));
