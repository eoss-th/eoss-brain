...
public class GetHTTPExpressionTest {
    ...
    public void getTest() {
        ...
        assertEquals("ดูดวงชะตารายวัน ประจำวันพุธที่ 20 มีนาคม 2562 ดูดวงรายวัน ผู้ที่เกิดวันเสาร์ วันนี้ไม่วายที่ต้องคิดมากและระแวงสงสัย หรือยังคงข้องใจตนกับคำพูดของคนแต่ วันวานมา หลายสิ่งมากอย่างต้องเปลี่ยนไป อาจเข้าใจผิดกับคนรอบข้างได้ง่าย เรื่องรักเราเองยังคงคิดมากไปเอง", session.parse(MessageObject.build("เสาร์")));
        assertEquals("เกิดวันอะไร", session.parse(MessageObject.build("ดวง")));
        assertEquals("ดูดวงชะตารายวัน ประจำวันพุธที่ 20 มีนาคม 2562 ดูดวงรายวัน ผู้ที่เกิดวันศุกร์ เรื่องต่างๆที่เกิดขึ้นจะเปลี่ยนร้ายกลายเป็นดี เช่น การเงินจะมีหนทาง การผลิตสินค้าเป็นที่นิยม เช่น การเงินจะมีหนทาง การผลิตสินค้าเป็นที่นิยม อาจมีความตื่นเต้นเกี่ยวกับการเดินทาง ความรักจะผิดหวังเนื่องจากการผิดนัด หรือล่าช้า.......", session.parse(MessageObject.build("ศุกร์")));
