...
public class GetHTTPExpressionTest {
    ...
    public void getTest() {
        ...
        assertEquals("ดูดวงชะตารายวัน ประจำวันเสาร์ที่ 09 มีนาคม 2562 ดูดวงรายวัน ผู้ที่เกิดวันเสาร์ ดวงมีดีหลายประการ ที่ขาดไม่ได้เลยคือ ความสุขสดใส ทำการใดก็ไม่ติดขัด มีคนมองเห็นความสำคัญ จะมีบทบาทในสังคมมากขึ้น ได้รับการชักนำให้เริ่มงานใหม่ๆที่นอกเหนือจากงานประจำ ด้านการเงินยังคงต้องลุยต่อไปด้วยความมุ่งมั่น เพราะเกิดความกระตือรือร้นมากขึ้นจึงต้องเหนื่อยในการหาเงิน", session.parse(MessageObject.build("เสาร์")));
        assertEquals("เกิดวันอะไร", session.parse(MessageObject.build("ดวง")));
        assertEquals("ดูดวงชะตารายวัน ประจำวันเสาร์ที่ 09 มีนาคม 2562 ดูดวงรายวัน ผู้ที่เกิดวันศุกร์ ด้านความรักค่อนข้างเปราะบาง อย่าใช้อารมณ์หรือหงุดหงิดเข้าหากัน คนรักคู่ครองอาจมีทีท่าเปลี่ยนแปลงไป ก็อย่าถือสาอะไรอีกไม่ช้าไม่นานก็จะกลับมาเป็นปกติ สำหรับการงานอาชีพคล่องตัวดี การติดต่อดำเนินกิจการต่าง ๆได้ผลดีเกินคาด ถ้าเป็นงานใช้คำพูด ใช้ความคิด ธุรกิจค้าขายมีแต่ผลดีเหนือความคาดหมาย การเงินของคุณเป็นไปด้วยดี มีเงินหมุนเวียนเข้ามาไม่ขาดสายจากรายได้ประจำและพิเศษ", session.parse(MessageObject.build("ศุกร์")));
