...
public class ExportMermaidDataCommandNodeTest {
    ...
    public void test() {
        ...
        /**
         ...
         "เกิด วัน อะไร ศุกร์:ดูด วง ศุกร์-->ดูด วง ศุกร์",
         "เกิด วัน อะไร เสาร์:ดูด วง เสาร์-->ดูด วง เสาร์",
         "เกิด วัน อะไร อาทิตย์:ดูด วง อาทิตย์-->ดูด วง อาทิตย์",
         "เกิด วัน อะไร จันทร์:ดูด วง จันทร์-->ดูด วง จันทร์",
         "เกิด วัน อะไร อังคาร:ดูด วง อังคาร-->ดูด วง อังคาร",
         "เกิด วัน อะไร พุธ:ดูด วง พุธ-->ดูด วง พุธ",
         "เกิด วัน อะไร พฤหัส:ดูด วง พฤหัส-->ดูด วง พฤหัส",
         "ฝัน ว่า อะไร:ทำนาย หวย-->ทำนาย หวย",
         "เช็ค ดวง:เกิด วัน อะไร-->เกิด วัน อะไร ศุกร์",
         "เช็ค ดวง:เกิด วัน อะไร-->เกิด วัน อะไร เสาร์",
         "เช็ค ดวง:เกิด วัน อะไร-->เกิด วัน อะไร อาทิตย์",
         "เช็ค ดวง:เกิด วัน อะไร-->เกิด วัน อะไร จันทร์",
         "เช็ค ดวง:เกิด วัน อะไร-->เกิด วัน อะไร อังคาร",
         "เช็ค ดวง:เกิด วัน อะไร-->เกิด วัน อะไร พุธ",
         "เช็ค ดวง:เกิด วัน อะไร-->เกิด วัน อะไร พฤหัส",
         "ใคร ?:ทักทาย-->ทักทาย ด้วง",
         "ใคร ?:ทักทาย-->ทักทาย นพ",
         "ใคร ?:ทักทาย-->ทักทาย คิม",
         "ใคร ?:ทักทาย-->ทักทาย อุ้ย",
         "ใคร ?:ทักทาย-->ทักทาย ดุก","ใคร ?:ทักทาย-->ทักทาย อั๋น","ใคร ?:ทักทาย-->ทักทาย ที","ใคร ?:ทักทาย-->ทักทาย","สวัสดี:ดี ฮะ ชื่อ ไร-->ดี ฮะ ชื่อ ไร","ฝัน:ฝัน ว่า อะไร-->ฝัน ว่า อะไร","ดวง:เกิด วัน อะไร-->เกิด วัน อะไร ศุกร์","ดวง:เกิด วัน อะไร-->เกิด วัน อะไร เสาร์","ดวง:เกิด วัน อะไร-->เกิด วัน อะไร อาทิตย์","ดวง:เกิด วัน อะไร-->เกิด วัน อะไร จันทร์","ดวง:เกิด วัน อะไร-->เกิด วัน อะไร อังคาร","ดวง:เกิด วัน อะไร-->เกิด วัน อะไร พุธ","ดวง:เกิด วัน อะไร-->เกิด วัน อะไร พฤหัส","hi:Hello what is your name-->Hello what is your name ?","ไง:ดี ฮะ ชื่อ ไร-->ดี ฮะ ชื่อ ไร","ดี:ดี ฮะ ชื่อ ไร-->ดี ฮะ ชื่อ ไร","เงี่ยน:ใคร-->ใคร ?"]}
         *
         */
